...
async function seed() {
  const concert = await prisma.concert.create({
    data: {
      ...
      date: new Date('2026-04-06T20:00:00Z'), // ✅ updated
      
      venue: 'Terraform Arena, Yelahanka',
      
      gatesOpenTime: new Date('2026-04-06T16:00:00Z'), // ✅ 4 hours before
  ...
  const categories = [
    { name: 'fanpit', price: 8500.0, totalSeats: 1000, availableSeats: 1000 },
    { name: 'platinum', price: 5000.0, totalSeats: 2000, availableSeats: 2000 },
    { name: 'gold', price: 3000.0, totalSeats: 3000, availableSeats: 3000 },
    { name: 'silver', price: 1500.0, totalSeats: 4000, availableSeats: 4000 },
  ];
